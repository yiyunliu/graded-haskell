...
# put in CoqSrc.mk.local double colon rules accordingly.
...
#
# There rules can be extended in CoqSrc.mk.local
...
# extension points and CoqSrc.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in CoqSrc.mk.local or include CoqSrc.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in CoqSrc.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create CoqSrc.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include CoqSrc.mk.local-late
