...
Inductive Typing : context -> grade -> tm -> tm -> Prop :=    (* defn Typing *)
 ...
 | T_AbsIrrel : forall (L:vars) (W:context) (psi psi0:grade) (A b B:tm) (s:sort),
      (  q_C   <  psi0 )  ->
      (  q_C   <  psi )  ->
      ( forall x , x \notin  L  -> Typing  (  ( x ~( psi0 , A ))  ++  (  (meet_ctx_l   q_C    W )  )  )   q_C   ( open_tm_wrt_tm b (a_Var_f x) )   ( open_tm_wrt_tm B (a_Var_f x) )  )  ->
...
(** infrastructure *)
Hint Constructors Step P_sub ctx_sub CGrade Grade CEq GEq CDefEq DefEq Typing CTyping Ctx ValueType Consistent CPar Par MultiPar Joins Value CMultiPar CJoins lc_tm : core.
